...
var background = _react2.default.createElement(
  'div',
  null,
  _react2.default.createElement('img', { src: '/images/ocean.jpg', className: 'background', alt: 'ocean' })
);
...
function displayFact(e) {
  ...
  var funFact = animalInfo.facts[optionIndex];document.getElementById('fact').innerHTML = funFact;
}
